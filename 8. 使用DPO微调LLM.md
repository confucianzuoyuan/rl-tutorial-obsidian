...
## 6. 使用TRL库中的DPOTrainer

数据集下载

```bash
$ git clone https://hf-mirror.com/datasets/trl-lib/ultrafeedback_binarized
$ mv ultrafeedback_binarized ultrafeedback_binarized_trl_lib
```
...
train_dataset = load_dataset(
    "./ultrafeedback_binarized_trl_lib",
    split="train"
)
