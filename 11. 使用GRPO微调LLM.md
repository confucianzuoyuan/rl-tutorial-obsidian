...
def rollout(
    ...
    for cur_pos in range(min_prompt_len, total_len):
        print(
            f"\r* 生成轨迹:                             \
            {cur_pos-min_prompt_len:>4d}               \
            /                                          \
            {total_len-min_prompt_len:>4d}",
            flush=True,
            end="",
        )
...
def main():
    ...
    for step, batch in enumerate(train_dataloader, start=1):
        ...
        print(
            f"\rStep {step}, 平均奖励: {mean_reward:.2f}, "
        ...
        tb_writer.add_scalar(
            "success_rate/train", success_rate, step)
        ...
        tb_writer.add_scalar(
            "mean_response_len", mean_response_len, step)
